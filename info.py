...
PICS = (environ.get('PICS', 'https://files.catbox.moe/0kvknj.jpg https://files.catbox.moe/q2dcnh.jpg https://files.catbox.moe/75frrs.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://files.catbox.moe/w2phqb.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://files.catbox.moe/q2dcnh.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://files.catbox.moe/qv1ysp.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://files.catbox.moe/whhe90.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://files.catbox.moe/rs5pl7.jpg')).split()  # Fsub pic
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://files.catbox.moe/7unw3g.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'Not Available')

#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '').split()]
TEXT = environ.get("APPROVED_WELCOME_TEXT", "f<b>{mention},\n\nʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴊᴏɪɴ <u>{title}</u> ʜᴀs ʙᴇᴇɴ ᴀᴘᴘʀᴏᴠᴇᴅ.\n\n‣ ᴘᴏᴡᴇʀᴇᴅ ʙʏ <a href='https://t.me/AniHorizon'>AniHorizon</a></b>")
...
DATABASE_NAME = environ.get('DATABASE_NAME', "sora")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'AniHorizon')
...
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1002525820868'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/AniHorizon')  # How to open tutorial link for verification
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/AniHorizon')  # Tutorial video link for opening shortlink website
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Momo_Ayase_bot')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+tRL29GgkqRQxZTVl')  # Support group link (make sure bot is admin)
